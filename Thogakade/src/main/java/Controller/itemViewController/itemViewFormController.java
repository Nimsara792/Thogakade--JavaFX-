...
public class itemViewFormController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        colDis.setCellValueFactory(new PropertyValueFactory<>("PackSize"));
        ...
        tblItems.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                txtItemID.setText(newVal.getItemCode());
                txtItemName.setText(newVal.getDescription());
                txtItemDescription.setText(newVal.getPackSize());
                txtItemPrice.setText(String.valueOf(newVal.getUnitPrice()));
                txtItemQuantityOnHand.setText(String.valueOf(newVal.getQtyOnHand()));
            }
        });
